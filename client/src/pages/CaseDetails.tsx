            ...
            {caseData.complaint ? (
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3.5 bg-indigo-950/20 border border-indigo-500/30 rounded-xl">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center text-xs font-semibold text-indigo-300 hover:text-white bg-indigo-600/20 hover:bg-indigo-600/30 px-3.5 py-2 min-h-[40px] rounded-xl border border-indigo-500/30 transition-colors shrink-0 self-start sm:self-auto"
                >
